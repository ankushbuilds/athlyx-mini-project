...
const AcademyDiscover = () => {
  ...
  const loadAthletes = async () => {
    ...
    try {
      ...
      setAthletes(matchingAthletes);
      setFilteredAthletes(matchingAthletes);
        ...
        <div className="coach-athletes-container">
          ...
          <div className="coach-athletes-header">
            ...
            <div>
              ...
              <p>
                Explore athletes matching your
                academy and discover new talent.
              </p>
          ...
          {loading && (
            <div className="coach-athletes-loading">
              ...
              <p>
                Finding athletes matching your
                academy.
              </p>
                  ...
                  <div className="coach-athletes-empty">
                    ...
                    <p>
                      {search
                        ...
                        : academySport
                          ? `No athletes found for ${academySport}.`
...
export default AcademyDiscover;