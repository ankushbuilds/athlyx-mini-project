...
const Toggle = ({ enabled, setEnabled, onChange, disabled }) => (
    <button
        type="button"
...
const CoachSettings = () => {
    ...
    const fetchSettings = async () => {
        try {
            ...
            setOpportunityNotifications(
                settings.opportunityNotifications ?? true
            );
    ...
    const handleChangeEmail = async (e) => {
        ...
        try {
            ...
            user.email = response.data.email || newEmail;
                ...
                <div className="settings-item">
                    <div className="settings-item-left">
                        ...
                        <div>
                            <h3>Profile</h3>
                            <p>
                                Manage your coaching details and profile information
                            </p>
                        </div>
                    </div>
                ...
                <div className="settings-item">
                    <div className="settings-item-left">
                        ...
                        <div>
                            ...
                            <p>
                                Control who can view your coach profile
                            </p>
                        </div>
                    </div>
                ...
                <div className="settings-item">
                    <div className="settings-item-left">
                        ...
                        <div>
                            ...
                            <p>
                                Show your contact information on your profile
                            </p>
                        </div>
                    </div>
                ...
                <div className="settings-item">
                    <div className="settings-item-left">
                        ...
                        <div>
                            ...
                            <p>
                                Get notified about new messages and athlete requests
                            </p>
                        </div>
                    </div>
                ...
                <div className="settings-item">
                    <div className="settings-item-left">
                        ...
                        <div>
                            ...
                            <p>
                                Receive notifications about relevant sports opportunities
                            </p>
                        </div>
                    </div>
                    ...
                    <Toggle
                        ...
                        onChange={(value) =>
                            updateSettings({
                                ...
                                contactVisible,
                                messageNotifications,
                                opportunityNotifications: value,
                                emailNotifications
                            })
                        }
                        disabled={
                ...
                <div className="settings-item delete-item">
                    <div className="settings-item-left">
                        ...
                        <div>
                            ...
                            <p>
                                Permanently delete your Athlyx account and coach profile
                            </p>
                        </div>
                    </div>
                ...
                <div className="settings-item">
                    <div className="settings-item-left">
                        ...
                        <div>
                            <h3>Logout</h3>
                            <p>
                                Sign out from your Athlyx account
                            </p>
                        </div>
                    </div>
            ...
            {showPasswordModal && (
                <div className="password-modal-overlay">
                    <div className="password-modal">
                        ...
                        <p>
                            Update your password to keep your Athlyx account secure.
                        </p>
